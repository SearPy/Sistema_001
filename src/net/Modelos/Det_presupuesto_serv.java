 ...
 */
@Entity
public class Det_presupuesto_serv implements Serializable{
    @Id
    ...
    public Det_presupuesto_serv() {
    }

    public Det_presupuesto_serv(int cantidad, int precio, Producto id_prod, Presupuesto_serv id_pres) {
