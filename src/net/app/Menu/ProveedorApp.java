...
public class ProveedorApp extends javax.swing.JDialog {
    ...
    private final ProveedorDaoImpl edao = new ProveedorDaoImpl(st);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantener Registro de Proveedores");
        jPanel1.add(jLabel1);
        ...
        jScrollPane1.setBounds(10, 320, 870, 140);
        ...
        jPanel1.add(informe);
        informe.setBounds(10, 470, 90, 40);
    ...
    private void informeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_informeActionPerformed
        try {
            ...
            Logger.getLogger(ProveedorApp.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void tableModel(){
        ...
        model.setNumRows(0);
        List<Proveedor> list = edao.list();
        for (Proveedor l : list){
            model.addRow(new Object[]{
                l.getId_prov(),l.getRuc(),l.getRazon_social(),l.getDireccion(),l.getTelefono()
            });
        }
    }
    ...
    private void guardar(){
        Proveedor cli = edao.buscarPorNom(txtruc.getText());
        if(!txtruc.getText().isEmpty() && !txtdireccion.getText().isEmpty() 
            ...
            if(guardar.getText().equals("Guardar")){
                if(cli == null){
                    Proveedor l = new Proveedor(txtruc.getText(), 
                    ...
                    JOptionPane.showMessageDialog(null, "Ya existe proveedor registrdo con este RUC");
                } 
                }else{
                Proveedor l = edao.buscarPorId(Integer.parseInt(txtid.getText()));
        ...
        if(tab.getRowCount()> 0){
            if(tab.isEnabled()){
                if(tab.getSelectedRow()> -1){
                   Proveedor l = edao.buscarPorId(Integer.parseInt(model.getValueAt(tab.getSelectedRow(),0).toString()));
                   txtid.setText(String.valueOf(l.getId_prov()));
    ...
    private void imprimir() throws JRException{
        LinkedList<Proveedor> info = new LinkedList();
        List<Proveedor> list = edao.list();
        for (Proveedor l : list){
         ...
         try {
            JasperReport reportes = (JasperReport) JRLoader.loadObject(new File ("src/Reportes/Proveedores.jasper"));
