 ...
 * @author RAMC
 */
public class CamionesApp extends javax.swing.JDialog {

    /**
     * Creates new form Libros
     */
    public CamionesApp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        arranque();
    ...
    private final CamionDaoImpl edao = new CamionDaoImpl(st);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantener Registro de Vehiculos");
        jPanel1.add(jLabel1);
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(120, 20, 50, 30);
    ...
    private void informeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_informeActionPerformed
        try {
            ...
            Logger.getLogger(CamionesApp.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CamionesApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CamionesApp dialog = new CamionesApp(new javax.swing.JFrame(), true);
    ...
    private void guardar(){
        Camion cli = edao.buscarPorNom(txtruc.getText());
        if(!txtruc.getText().isEmpty() && !txtdireccion.getText().isEmpty() 
            ...
            if(guardar.getText().equals("Guardar")){
                if(cli == null){
                    Camion l = new Camion(txtruc.getText(), 
                    ...
                    JOptionPane.showMessageDialog(null, "Ya existe camion registrdo con esta chapa");
                } 
                }else{
                Camion l = edao.buscarPorId(Integer.parseInt(txtid.getText()));
        ...
        if(tab.getRowCount()> 0){
            if(tab.isEnabled()){
                if(tab.getSelectedRow()> -1){
                   Camion l = edao.buscarPorId(Integer.parseInt(model.getValueAt(tab.getSelectedRow(),0).toString()));
    ...
    private void imprimir() throws JRException{
        LinkedList<Camion> info = new LinkedList();
        List<Camion> list = edao.list();
        for (Camion l : list){
         ...
         try {
            JasperReport reportes = (JasperReport) JRLoader.loadObject(new File ("src/Reportes/Camions.jasper"));
