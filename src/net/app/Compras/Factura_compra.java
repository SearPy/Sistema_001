...
import net.dao.Det_factura_com_daoimpl;
...
public class Factura_compra extends javax.swing.JDialog {
     ...
     */
    public Factura_compra(java.awt.Frame parent, boolean modal) throws UnknownHostException {
        super(parent, modal);
        initComponents();
        arranque();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Registro de Factura de Compras");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Factura_compra dialog = null;
                try {
                    dialog = new Factura_compra(new javax.swing.JFrame(), true);
                } catch (UnknownHostException ex) {
                    Logger.getLogger(Factura_compra.class.getName()).log(Level.SEVERE, null, ex);
                }
