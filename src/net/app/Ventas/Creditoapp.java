 ...
 * @author Ramc
 */
public class Creditoapp extends javax.swing.JDialog {

    /**
     * Creates new form Presupuesto
     */
    public Creditoapp(java.awt.Frame parent, boolean modal) throws UnknownHostException {
        super(parent, modal);
        initComponents();
        arranque();
    ...
    private final Factura_ven_daoimpl ordao = new Factura_ven_daoimpl(st);
    private final Nota_credito_ven_daoimpl ncdao = new Nota_credito_ven_daoimpl(st);
    private final Det_nota_credito_ven_daoimpl dtdao = new Det_nota_credito_ven_daoimpl(st);
    ...
    private void initComponents() {
        ...
        jLabel28.setText("Buscar Factura");
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Factura de venta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
        ...
        botbuscarpedido.setText("Buscar Factura");
    ...
    private void botimprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botimprimirActionPerformed
        try {
            ...
            Logger.getLogger(Creditoapp.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Creditoapp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Creditoapp dialog = null;
                try {
                    dialog = new Creditoapp(new javax.swing.JFrame(), true);
                } catch (UnknownHostException ex) {
                    Logger.getLogger(Creditoapp.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void tabpedidos(){
        ...
        List<Factura_ven> list = ordao.list();
    ...
    private void retornarFactura(){
        if(tablaped.getRowCount() > 0){
            ...
            Factura_ven or = ordao.buscarPorId(Integer.parseInt(modelpe.getValueAt(tablaped.getSelectedRow(), 0).toString()));
            txtpedido.setText(String.valueOf(or.getId_fac()));
            combotipo.setSelectedItem(or.getTipo());
            txtfechafac.setText(retornarString(or.getFecha() ));
            ...
            List<Det_factura_ven> dt =or.getDetalles();
            model.setNumRows(0);
            tabla.setEnabled(true);
    ...
    private void tablaPresupuesto(){
        ...
        List<Nota_credito_ven> list = ncdao.list();
        for (Nota_credito_ven l : list){
    ...
    private void retornarPresupuesto(){
        if(tablapres.getRowCount() > 0){
            ...
            Nota_credito_ven pe = ncdao.buscarPorId(Integer.parseInt(modelpres.getValueAt(tablapres.getSelectedRow(), 0).toString()));
            ...
            List<Det_nota_credito_ven> dt =pe.getDetalles();
            model.setNumRows(0);
            tabla.setEnabled(false);
            for (Det_nota_credito_ven p : dt) {
                model.addRow(new Object[]{
                    p.getCantidad(),p.getId_prod().getId_prod(),p.getId_prod().getDescripcion(),p.getPrecio(),(p.getCantidad() * p.getPrecio())
                });
            } 
                ...
                if(!txtruc.getText().isEmpty()){
                    if(!txtpedido.getText().isEmpty() && !txttimbrado.getText().isEmpty() && !txtfechafac.getText().isEmpty() && combotipo.getSelectedIndex() > -1){
                        if(JOptionPane.showConfirmDialog(null, "Desea guardar este registro,.", "Mensaje del Sistema.", JOptionPane.YES_OPTION) == 0){
                            ...
                            Cliente prov = cdao.buscarPorId(Integer.parseInt(txtnroproveedor.getText()));
                            Factura_ven ord = ordao.buscarPorId(Integer.parseInt(txtpedido.getText()));
                            String pag = "A PAGAR";
                            if(combotipo.getSelectedItem().equals("Contado")){
                                pag = "PAGADO";
                            }
                            Nota_credito_ven fac = new   Nota_credito_ven(txttimbrado.getText(),f,txtfechafac.getText(),combotipo.getSelectedItem().toString(),
                                ...
                                for (int i = 0; i < tabla.getRowCount(); i++) {
                                    Det_nota_credito_ven dt= new Det_nota_credito_ven();
                            ...
                            Libroivaven li = new Libroivaven(f, Integer.parseInt(txttotal10.getText()),Integer.parseInt(txttotal5.getText()),"credito", null,fac);
                            lidao.guardar(li);
                            arranque();
                        } 
                    }else{
    ...
    private void anular(){
        if(JOptionPane.showConfirmDialog(null, "Desea anular este registro,.", "Mensaje del Sistema.", JOptionPane.YES_OPTION) == 0){
            if(!txtnro.getText().isEmpty()){
                Nota_credito_ven fac = ncdao.buscarPorId(Integer.parseInt(txtnro.getText()));
                Factura_ven or = ordao.buscarPorId(Integer.parseInt(txtpedido.getText()));
                if(fac.getEstado().equals("ACTIVO")){
                    ...
                    Libroivaven li = new Libroivaven(f, Integer.parseInt(txttotal10.getText()),Integer.parseInt(txttotal5.getText()),"debito", null,fac);
                            lidao.guardar(li);
    ...
    private int id;
    private void id(){
       List<Nota_credito_ven> listvn=ncdao.list();
       id=1;
       for(Nota_credito_ven ven: listvn){
           id=ven.getId_nc()+1;
       }
    ...
    private void imprimir() throws JRException{  
         try {
            Nota_credito_ven fc = ncdao.buscarPorId(Integer.parseInt(txtnro.getText()));
            List fac=new ArrayList();
            List<Det_nota_credito_ven> list = fc.getDetalles(); 
            for(Det_nota_credito_ven dt: list){
